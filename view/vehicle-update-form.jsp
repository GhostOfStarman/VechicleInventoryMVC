...
<head>
	...
	<link type="text/css"
	rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/UpdateVehicleFormCSS.css">
...
<body>
		...
		<div id="updateVehTitle">
			<img src="${pageContext.request.contextPath}/resources/images/UpdateVehHeader.svg"/>    
		</div>
		
		<div class="container">

			<form:form action="updateVehicleSave" modelAttribute="Vehicle" method="POST">
